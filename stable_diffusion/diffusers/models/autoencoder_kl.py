...
class AutoencoderKL(ModelMixin, ConfigMixin):
    ...
    def _decode(self, z: torch.FloatTensor, return_dict: bool = True) -> Union[DecoderOutput, torch.FloatTensor]:
        ...
        #print(z.requires_grad, 'z 0.5')
        self.post_quant_conv.requires_grad_(True)
        self.post_quant_conv.weight.requires_grad = True
        self.post_quant_conv.bias.requires_grad = True
        #print(self.post_quant_conv.weight.requires_grad, 'post_quant_conv.weight.requires_grad')
        z = self.post_quant_conv(z)
        #print(z.requires_grad, 'z 1')
        self.decoder.requires_grad_(True)
        dec = self.decoder(z)
        #print(dec.requires_grad, 'dec')
